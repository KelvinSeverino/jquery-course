$(function() {
    //FIND - Busca elemento atraves de outro elemento/seletor
    ...
    //NEXT E NEXT ALL - Obtem o irmao seguinte do elemento selecionado ou o antecessor
    ...
    $(".article_content p:last").prevUntil("", ".active").fadeIn(2000);
});
